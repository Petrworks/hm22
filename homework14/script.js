...
//Ми викликаємо функцію addBase з аргументом 1,  отримуємо функцію, яку ми призначаємо змінній addOne. Потім ми викликаємо addOne(5), поверне 1+5, і addOne(3), поверне 1+3. Вивід alert - 10
